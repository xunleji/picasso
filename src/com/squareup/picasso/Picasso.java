...
public class Picasso {
	...
	Picasso(Context context, Dispatcher dispatcher, Cache cache,
			...
			Stats stats, boolean indicatorsEnabled) {
	...
	/**
	 * @deprecated Use {@link #areIndicatorsEnabled()} instead. {@code true} if
	 *             debug display, logging, and statistics are enabled.
	 */
	...
	/**
	 * @deprecated Use {@link #setIndicatorsEnabled(boolean)} instead. Toggle
	 *             whether debug display, logging, and statistics are enabled.
	 */
	@SuppressWarnings("UnusedDeclaration")
	@Deprecated
	...
	public static class Builder {
		...
		public Picasso build() {
			...
			return new Picasso(context, dispatcher, cache, listener,
					transformer, stats, indicatorsEnabled);
		}
	}
